...
```{r}
NHLALL = read.csv("/Users/bavalanthangarajah/Desktop/Project2/NHLMega.csv",header=TRUE)
NHLALL
```

```{r}
train=read.csv("/Users/bavalanthangarajah/Desktop/Project2/Training.csv",header=TRUE)
attach(train)
train
```
...
Champs~Rk+GP+W+L+W.L.+G+GA+DIFF+CQF.GP+CQF.OT.GP+CQF.W.L.+CQF.RS.W.L.+ CSF.GP+CSF.OT.GP+CSF.W.L.+CSF.RS.W.L.+CF.GP+CF.OT.GP+CF.W.L.+CF.RS.W.L.+F.GP+F.OT.GP+F.W.L.+F.RS.W.L.+ELITE.F+ELITE.D+ELITE.GK+Year+AvAge+EXP
